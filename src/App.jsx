...
export default function App() {
 ...
 const groupedItems = useMemo(() => {
   ...
   allItemNames.forEach(normName => {
        ...
        // Reālais atlikums. Ja tas ir negatīvs (manuāli pievienots grozam), mēs to SAGLABĀJAM!
        const inStock = fireItem ? (fireItem.inStock || 0) : 0;
        
        // Kopējais nepieciešamais daudzums = (Cik prasa recepte) - (Cik ir ledusskapī)
        // Ja ledusskapī ir mīnuss (piem., -2), tad 0 - (-2) = 2. Precīzi 2 parādīsies grozā!
        const finalNeed = recipeNeed - inStock;
        
        // Ja neko nevajag pirkt, ignorējam
